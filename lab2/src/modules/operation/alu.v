...
always @(*) begin
  case (alu_func)
    ...
    `OP_BGEU: check = ($unsigned(in_a) >= $unsigned(in_b)) ? 1'b1 : 1'b0;
    4'b1100: check = (in_a == in_b) ? 1'b1 : 1'b0; // `OP_BEQ
    4'b1101: check = (in_a != in_b) ? 1'b1 : 1'b0; // `OP_BNE
    4'b1110: check = ($signed(in_a) < $signed(in_b)) ? 1'b1 : 1'b0; // `OP_BLT
    4'b1111: check = ($unsigned(in_a) < $unsigned(in_b)) ? 1'b1 : 1'b0; // `OP_BLTU
    //////////////////////////////////////////////////////////////////////////
    default:  check = 1'b0;
  endcase
end
